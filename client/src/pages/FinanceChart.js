...
function FinanceDisplay() {
  return (
    <div>
     Finance Charts.<br></br>
      <p>Take control of your finances with Wollet App - your personal finance partner. Create personalised 'pots' to save for specific goals, track your spending with financial accountability reports and secure authorisation for added peace of mind. 
      <br></br>
      <br></br>
